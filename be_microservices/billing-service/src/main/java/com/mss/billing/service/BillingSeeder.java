...
public class BillingSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        unit("402", "Skyview Tower", "Suite", "Occupied", "John Doe", new BigDecimal("1354000"));
        unit("402B", "Skyview Tower", "Penthouse", "Occupied", "Alex Thompson", BigDecimal.ZERO);
        unit("115A", "Ocean Tower", "Standard", "Occupied", "Sarah Jenkins", new BigDecimal("12500000"));
        unit("303C", "Garden Tower", "Standard", "Occupied", "Michael Rivera", new BigDecimal("3000000"));
        unit("208", "Skyview Tower", "Studio", "Occupied", "Elena Rossi", new BigDecimal("9500000"));
        unit("312", "Garden Tower", "Standard", "Occupied", "Jordan Lee", new BigDecimal("18500000"));
        unit("105", "Skyview Tower", "Standard", "Vacant", null, BigDecimal.ZERO);
    ...
    private void unit(String unitNumber, String tower, String unitType, String occupancyStatus, String residentName, BigDecimal balance) {
